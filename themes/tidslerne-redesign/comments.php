...
<div id="comments" class="mt-12">
                    ...
                    <li <?php comment_class("flex items-start gap-4 bg-gray-100 p-4 $margin_class $margin_bottom"); ?> id="comment-<?php comment_ID(); ?>">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-1">
                                <span class="font-semibold text-[#9B2D5C]"><?php echo get_comment_author(); ?></span>
                            ...
                            <div class="text-xs">
                                ...
                                comment_reply_link(array_merge($args, [
                                    ...
                                    'class'      => 'text-[#9B2D5C] hover:underline'
                                ]));
                                ?>
                            </div>
                        </div>
    ...
    if ( comments_open() ) {
        comment_form([
            'class_submit' => 'bg-[#9B2D5C] text-white px-6 py-2 rounded-lg font-bold hover:bg-[#7a2348] transition cursor-pointer',
            'title_reply'  => '<span class="text-lg font-bold py-2">Efterlad et svar</span>',
